...
const QuickLinkTile = ({
  ...
  return (
    <Link
      href={href}
      className="adnexa-glass-card flex items-center gap-3 rounded-2xl p-3 transition-all duration-300 hover:-translate-y-1"
    >
      {/* ────────── Quick Link Icon ────────── */}
      <div
        className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br ${variantClass[variant]}`}
      >
