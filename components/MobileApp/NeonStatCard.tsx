...
const NeonStatCard = ({
  ...
  return (
    <div className="adnexa-glass-card rounded-[26px] p-4">
      {/* ────────── Stat Icon ────────── */}
      <div
        className={`mb-4 flex h-12 w-12 items-center justify-center rounded-2xl border bg-gradient-to-br ${variantClass[variant]}`}
      >
