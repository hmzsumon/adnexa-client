...
const MethodCard = ({
  ...
  const content = (
    <div
      className={`adnexa-glass-card group rounded-2xl my-4 border bg-gradient-to-br p-4 transition-all duration-300 ${accentClass[accent]} ${
        isActive ? "hover:-translate-y-1" : "opacity-70"
      }`}
    >
      {/* ────────── Method Header ────────── */}
      <div className="flex items-center justify-between gap-3">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <span
              className={`mt-1 inline-flex items-center gap-1 rounded-full px-3 py-1 text-[11px] font-black ${
                isActive
