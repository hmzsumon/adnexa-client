...
export const authApi = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    // check mobile exist or not post request
    checkPhoneExistOrNot: builder.mutation<any, any>({
      query: (body) => ({
    ...
    // old register step support - now this checker also works with mobile number
