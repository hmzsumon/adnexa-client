...
const DepositHistory = () => {
  ...
  return (
    <div className="space-y-6 text-white">
      ...
      <section className="relative overflow-hidden rounded-[32px] border border-teal-400/20 bg-gradient-to-br from-teal-500/15 via-indigo-950/90 to-violet-950/50 p-5">
        ...
        <div className="relative z-10 flex items-start justify-between gap-4">
          ...
          <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-[26px] border border-teal-400/25 bg-teal-400/12 text-teal-300">
