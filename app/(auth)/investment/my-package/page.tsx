...
const MyPackage = () => {
  ...
  return (
    <div className="space-y-6 text-white">
      ...
      <section className="relative overflow-hidden rounded-[32px] border border-violet-400/20 bg-gradient-to-br from-violet-600/25 via-indigo-950/90 to-cyan-950/35 p-5">
        <div className="pointer-events-none absolute -right-8 -top-8 h-40 w-40 rounded-full bg-violet-400/20 blur-2xl" />
        <div className="relative z-10 flex items-center gap-4">
          <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-[26px] border border-violet-400/25 bg-violet-500/15 text-violet-300 shadow-[0_0_35px_rgba(139,92,246,.18)]">
          ...
          <div>
            ...
            <h2 className="mt-1 text-3xl font-black">Your Plan Status</h2>
